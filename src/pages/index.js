...
export default function Home(props) {
  ...
  if (~"nico".indexOf(props.location.search))
    dashboard = <RenderProvi></RenderProvi>;
  else
    dashboard = <RenderNico></RenderNico>;
  ...
  <div className="layout layout-header-fixed">
    <div className="layout-header">
      <div className="navbar navbar-default">
        <div className="navbar-header">
          <a className="navbar-brand navbar-brand-center" ui-sref="dashboards.dashboard-1" href="#!/dashboard">
          ...
          <nav id="navbar" className="navbar-collapse collapse">
            ...
            <ul className="nav navbar-nav navbar-right">
              ...
              <li className="dropdown">
                ...
                <div className="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                  <div className="dropdown-header">
                    <a className="dropdown-link" href="compose.html">New Message</a>
                  ...
                  <div className="dropdown-footer">
                    <a className="dropdown-btn" href="#">See All</a>
                  </div>
                </div>
              </li>
              <li className="dropdown">
                ...
                <div className="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                  <div className="dropdown-header">
                    <a className="dropdown-link" href="#">Mark all as read</a>
              ...
              <li className="dropdown hidden-xs">
                <button className="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <ul className="dropdown-menu dropdown-menu-right">
                  <li>
                    <a ui-sref="signup-1.step-two" href="#!/signup/step-two">
                  ...
                  <li className="divider"></li>
                  <li><a ui-sref="root.contacts" href="#!/contacts">Contacts</a></li>
                  <li><a ui-sref="root.profile" href="#!/profile">Profile</a></li>
                  <li><a ui-sref="login-1" href="#!/login">Sign out</a></li>
                </ul>
              </li>
              <li className="visible-xs-block">
                <a ui-sref="root.contacts" href="#!/contacts">
                  <span className="icon icon-users icon-lg icon-fw"></span>
                  Contacts
                </a>
              </li>
              <li className="visible-xs-block">
                <a ui-sref="root.profile" href="#!/profile">
                  <span className="icon icon-user icon-lg icon-fw"></span>
                  Profile
                </a>
              </li>
              <li className="visible-xs-block">
                <a ui-sref="login-1" href="#!/login">
      ...
      <div className="layout-sidebar-body">
        <div className="custom-scrollable-area">
          <div className="custom-scrollbar" custom-scrollbar="" color="#fff" opacity="0.15">
            <nav className="sidenav-collapse collapse" uib-collapse="app.sidebar.xs.isCollapsed" aria-expanded="false"
              aria-hidden="true">
              <ul className="sidenav level-1" side-navigation="">
                <li className="sidenav-item active" ui-sref-active="open active">
                  <a ui-sref="root.page-layouts" href="/">
    ...
    <div className="layout-footer">
      <div className="layout-footer-body">
        ...
        <small className="copyright">2018 © Elephant <a href="http://madebytilde.com/">Made by Tilde</a></small>
      </div>
    </div>
  </div>)
}
